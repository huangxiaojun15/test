...
本文档依据 `.github/workflows/build_and_release.yml` 整理，说明构建矩阵、三个 job 的职责、各产物打包流程及命名规则。
...
## 4. Job：build-and-release（SGL-Kernel-NPU）
...
## 6. Job：build-cuntom-ops（custom-ops）
